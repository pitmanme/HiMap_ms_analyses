...
reference.ligand <- c("m14")
LIGAND_1 <- c("m0", "m0", "m0", "m0", "m0", "m0", "m0", "m0", "m0", "m0", "m0", "m0", "m0", "m0", "m14")
LIGAND_2 <- c("m8", "m3", "m2", "m11", "m5", "m14", "m4", "m7", "m12", "m6", "m1", "m13", "m13", "m9", "m15")

SIM <- c(0.081330909, 0.606207415, 0.740605297, 0.818581836, 0.148869969, 0.121735505, 0.606207415, 0.099519684, 0.121735505, 0.121735505, 0.90475924, 0.121735505, 0.90475924, 0.670049206, 0.690049206)

SIM_WEIGHT <- c((SIM^2 - min(SIM)^2)/(max(SIM)^2 - min(SIM)^2))
