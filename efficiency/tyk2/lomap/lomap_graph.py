...
db_mol = lomap.DBMolecules('/Users/mpitman/work/gits/packages/Lomap-main/examples/PLB_optim_data/lomap_similarities/tyk2', output=True, radial=False )
...
strict_numpy = strict.to_numpy_2D_array()*0.2
loose_numpy = loose.to_numpy_2D_array()*0.2
...
print("weight_col[0] = {}".format(weight_col[0]))
"""
