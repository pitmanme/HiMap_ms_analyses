...
# tnks2
ligand.list <- c("m0", "m1", "m2", "m3", "m4", "m5", "m6", "m7", "m8", "m9", "m10", "m11", "m12", "m13", "m14", "m15", "m16", "m17", "m18", "m19", "m20")
reference.ligand <- c("m0")
LIGAND_1 <- c("m0", "m0", "m0", "m2", "m3", "m3", "m4", "m4", "m5", "m5", "m5", "m7", "m7", "m7", "m7", "m7", "m8", "m9",  "m9", "m10", "m10", "m11", "m12", "m14", "m16", "m17", "m18")
LIGAND_2 <- c("m1", "m2", "m4", "m4", "m7", "m20", "m6", "m12", "m6", "m13", "m15", "m8", "m13", "m16", "m17", "m20", "m20", "m14",  "m15", "m11", "m12", "m12", "m16", "m16", "m18", "m19", "m19")
WEIGHT <- c(0.8187307530779818, 0.6703200460356393, 0.6703200460356393, 0.951229424500714, 0.951229424500714, 0.9048374180359595, 0.9048374180359595, 0.9048374180359595, 0.951229424500714, 0.9048374180359595, 0.9048374180359595, 0.951229424500714, 0.9048374180359595, 0.9048374180359595, 0.7408182206817179, 0.951229424500714, 0.9048374180359595, 0.9048374180359595, 0.9048374180359595, 0.8913661439068313, 0.951229424500714, 0.8607079764250578, 0.9048374180359595, 0.951229424500714, 0.7408182206817179, 0.9048374180359595, 0.8187307530779818)
...
SIM_WEIGHT <- c((WEIGHT^2 - ((minim-0.000001)^2))/(maxim^2 - minim^2))
print(SIM_WEIGHT)
