...
db_mol = lomap.DBMolecules('/Users/mpitman/work/gits/packages/Lomap-main/examples/PLB_optim_data/lomap_similarities/cdk2', output=True, radial=False)
