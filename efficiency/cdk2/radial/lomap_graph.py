...
db_mol = lomap.DBMolecules('/Users/mpitman/work/gits/packages/Lomap-main/examples/PLB_optim_data/lomap_similarities/cdk2', output=True, radial=True )
...
print("column[0] = {}".format(columns[3]))

weight_col = list(zip(weight))
print("weight_col[0] = {}".format(weight_col[3]))
